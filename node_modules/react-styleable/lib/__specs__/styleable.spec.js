...
function mkFixtureWithReqPropTypes() {
  ...
  Subject.propTypes = {
    aReqProp: _propTypes2.default.string.isRequired
  };
...
describe('styleable', function () {
  it('creates a default stylesheet if none supplied', function () {
    ...
    var component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(Subject, null));
  ...
  describe('with invalid stylesheet', function () {
    it('rejects css as strings', function () {
      ;(function () {
        ...
        _testUtils2.default.renderIntoDocument(_react2.default.createElement(Subject, null));
  ...
  describe('with invalid selectors (superset)', function () {
    it('rejects override styles that wont be used', function (done) {
      var origCss = { content: 'hash' };
      var overrideCss = { unusedSelector: 'anotherHash' };
      var Subject = mkFixture(origCss);
      try {
        _testUtils2.default.renderIntoDocument(_react2.default.createElement(Subject, { css: overrideCss }));
      } catch (e) {
        /*
    ...
    it('rejects compose styles that wont be used', function (done) {
      var origCss = { content: 'hash' };
      var overrideCss = { compose: { unusedSelector: 'anotherHash' } };
      var Subject = mkFixture(origCss);
      try {
        _testUtils2.default.renderIntoDocument(_react2.default.createElement(Subject, { css: overrideCss }));
      } catch (e) {
  ...
  it('overrides original stylesheet', function () {
    ...
    var Subject = mkFixture(origCss);
    var component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(Subject, { css: overrideCss }));
    _reactDom2.default.findDOMNode(component).className.should.eql(newHash);
  });

  it('composes new css', function () {
    var origCss = { content: 'hash' };
    var overrideCss = { compose: { content: 'anotherHash' } };
    var Subject = mkFixture(origCss);
    var component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(Subject, { css: overrideCss }));
    _reactDom2.default.findDOMNode(component).className.should.eql('hash anotherHash');
  });
  ...
  describe('with stateless functions', function () {
    it('makes the css prop available', function () {
      ...
      var component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(
        'div',
        null,
